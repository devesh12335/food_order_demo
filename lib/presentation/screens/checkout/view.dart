...
class CheckoutScreen extends StatelessWidget {
  ...
  static const String _userAddress = '123 Main Street, Apt 4B, Anytown, CA 90210';
        ...
        duration: const Duration(seconds: 1),
            ...
            _buildInfoCard(
              children: [
                ...
                _buildPriceRow('Grand Total', _grandTotal, Colors.teal, isTotal: true),
              ],
            ),
          ],
        ),
    ...
    return Container(
      ...
      SnackBar(
        ...
        style: ElevatedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12.0), // Curved button corners
          ),
